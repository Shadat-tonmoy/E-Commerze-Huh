                            ...
                            <form action="/upload" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="price" title="Product Price" name="price" placeholder="Price"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="discount" name="discount" title="Discount" placeholder="Discount in percentage"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="switch switch-text switch-primary switch-pill">
                                        <input type="checkbox" class="switch-input" title="Tap to change" checked="true" name="available">
